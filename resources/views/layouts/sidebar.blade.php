    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a href="{{ route('index') }}" class="nav-link menu-link"> <i class="bi bi-speedometer2"></i>
                        <span data-key="t-dashboard">{{ __('t-dashboard') }}</span> <span
                            class="badge badge-pill bg-danger-subtle text-danger"
                            data-key="t-hot">{{ __('t-hot') }}</span></a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('country.list') }}" class="nav-link menu-link"><i class="bi bi-speedometer2"></i>
                        <span data-key="Country">{{ __('Country') }}</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('province.list') }}" class="nav-link menu-link"><i
                            class="bi bi-speedometer2"></i> <span data-key="Province ">{{ __('Province') }}</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('city.list') }}" class="nav-link menu-link"><i class="bi bi-speedometer2"></i>
                        <span data-key="City">{{ __('City') }}</span> </a>
                </li>
                <li class="nav-item">
