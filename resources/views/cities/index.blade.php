    ...
    <div class="row" id="City-List">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="row g-3">
                        <form class="col-lg-10" method="get" action="{{ route('city.list') }}">
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="search-box">
                                        <input type="text" value="{{ @$request['param'] }}" name="param" id="param"
                                            class="form-control search" id="input-search" placeholder="Search Cities...">
                        ...
                        {{-- <form class="" method="get" action="{{ route('city.list') }}">
                            <div class="col-lg-3">
                                <div class="search-box">
                                    <input type="text" value="{{ @$request['param'] }}" name="param" id="param"
                                        class="form-control search" id="input-search" placeholder="Search Province...">
