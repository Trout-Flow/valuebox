                                            ...
                                            <div class="d-flex gap-2">
                                                ...
                                                <div class="remove ">
                                                    <a class="bi bi-trash " style="font-size: 1.3rem; color: rgb(255, 58, 68);"
                                                        data-bs-toggle="modal"  data-id="{{ $area->id  }}" data-bs-target="#deleteRecordModal"></a>
                                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-md-5">
                    ...
                    <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                        ...
                        <a href="{{ route('seller.delete') }}" type="button" class="btn w-sm btn-danger btn-hover" id="delete-record">Yes, Delete
                            It!</a>
                    </div>
                </div>
            </div><!-- /.modal-content -->
