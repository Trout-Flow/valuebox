...
@section('content')
    ...
    <div class="row row-cols-xxl-5 row-cols-lg-4 row-cols-sm-2 row-cols-1" id="brand-list">
        <!--  <div class="col">
            <div class="card brand-widget card-animate">
                <div class="card-body text-center pb-2">
                    <img src="{{ URL::asset('build/images/brands/img-1.png') }}" alt="" class="brand-img">
                </div>
        ...
        <div class="col">
            <div class="card brand-widget card-animate">
                <div class="card-body text-center pb-2">
                    <img src="{{ URL::asset('build/images/brands/img-2.png') }}" alt="" class="brand-img">
                </div>
                <div class="card-footer text-center border-0">
        ...
        <div class="col">
            <div class="card brand-widget card-animate">
                <div class="card-body text-center pb-2">
                    <img src="{{ URL::asset('build/images/brands/img-3.png') }}" alt="" class="brand-img">
                </div>
                <div class="card-footer text-center border-0">
        ...
        <div class="col">
            <div class="card brand-widget card-animate">
                <div class="card-body text-center pb-2">
                    <img src="{{ URL::asset('build/images/brands/img-4.png') }}" alt="" class="brand-img">
                </div>
                <div class="card-footer text-center border-0">
        ...
        <div class="col">
            <div class="card brand-widget card-animate">
                <div class="card-body text-center pb-2">
                    <img src="{{ URL::asset('build/images/brands/img-5.png') }}" alt="" class="brand-img">
                </div>
                <div class="card-footer text-center border-0">
        ...
        <div class="col">
            <div class="card brand-widget card-animate">
                <div class="card-body text-center pb-2">
                    <img src="{{ URL::asset('build/images/brands/img-6.png') }}" alt="" class="brand-img">
                </div>
                <div class="card-footer text-center border-0">
        ...
        <div class="col">
            <div class="card brand-widget card-animate">
                <div class="card-body text-center pb-2">
                    <img src="{{ URL::asset('build/images/brands/img-7.png') }}" alt="" class="brand-img">
                </div>
                <div class="card-footer text-center border-0">
        ...
        <div class="col">
            <div class="card brand-widget card-animate">
                <div class="card-body text-center pb-2">
                    <img src="{{ URL::asset('build/images/brands/img-8.png') }}" alt="" class="brand-img">
                </div>
                <div class="card-footer text-center border-0">
        ...
        <div class="col">
            <div class="card brand-widget card-animate">
                <div class="card-body text-center pb-2">
                    <img src="{{ URL::asset('build/images/brands/img-9.png') }}" alt="" class="brand-img">
                </div>
                <div class="card-footer text-center border-0">
        ...
        <div class="col">
            <div class="card brand-widget card-animate">
                <div class="card-body text-center pb-2">
                    <img src="{{ URL::asset('build/images/brands/img-10.png') }}" alt="" class="brand-img">
                </div>
                <div class="card-footer text-center border-0">
        ...
        <div class="col">
            <div class="card brand-widget card-animate">
                <div class="card-body text-center pb-2">
                    <img src="{{ URL::asset('build/images/brands/img-11.png') }}" alt="" class="brand-img">
                </div>
                <div class="card-footer text-center border-0">
        ...
        <div class="col">
            <div class="card brand-widget card-animate">
                <div class="card-body text-center pb-2">
                    <img src="{{ URL::asset('build/images/brands/img-12.png') }}" alt="" class="brand-img">
                </div>
                <div class="card-footer text-center border-0">
        ...
        <div class="col">
            <div class="card brand-widget card-animate">
                <div class="card-body text-center pb-2">
                    <img src="{{ URL::asset('build/images/brands/img-13.png') }}" alt="" class="brand-img">
                </div>
                <div class="card-footer text-center border-0">
        ...
        <div class="col">
            <div class="card brand-widget card-animate">
                <div class="card-body text-center pb-2">
                    <img src="{{ URL::asset('build/images/brands/img-14.png') }}" alt="" class="brand-img">
                </div>
                <div class="card-footer text-center border-0">
