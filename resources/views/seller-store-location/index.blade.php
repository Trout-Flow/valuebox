    ...
    <div class="row" id="sellersList">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="row g-3">
                        <form class="col-lg-10" method="get" action="{{ route('sellerStore.list') }}">
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="search-box">
                                        <input type="text" value="{{ @$request['param'] }}" name="param" id="param"
                                            class="form-control search" id="input-search" placeholder="Search Seller Stores...">
                ...
                <div class="card-body">
                    ...
                    <nav aria-label="Page navigation">
                        <ul class="pagination justify-content-end">
                            {!! $sellerStores->appends(request()->query())->links() !!}
                        </ul>
                    </nav>
                </div>
            </div>
