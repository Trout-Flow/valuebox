                            ...
                            <div class="card-header bg-primary border-0">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-9">
                                        <h1 class="text-white fs-120 fw-lighter">Welcome to ValueBox </h1>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <p class="text-muted fs-15">Sign in to continue to ValueBox.</p>
                                <div class="p-2">
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">©
                                ...
                                </script> ValueBox. All Rights Reserved.
                            </p>
                        </div>
                    </div>
                </div>
