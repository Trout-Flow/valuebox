                            ...
                            @foreach ($provinces as $province )
                                <a href="{{route('province.edit', ['id'=>$province->id])}}">
                                    <tr id="province{{$province->id}}">
                                        <td title="{{ $province->country_id }}">{{ $province->country_id }}</td>
                                        <td title="{{ $province->name }}">{{ $province->name }}</td>
                                        <td class="project-actions float-right">
                                            <a class="btn btn-primary btn-sm"
                                                href="{{ route('province.edit', $province->id) }}"
                                                data-id="{{ $province->id }}" title="Edit">
                                                <i class="fas fa-pencil-alt"></i>
                                            </a>
                                            <a class="btn btn-primary btn-sm deleteprovince"
                                                href="{{ route('province.delete', $province->id) }}"
                                                data-id="{{ $province->id }}" title="Delete">
